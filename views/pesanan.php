				...
				<div class="container" id="navbar-right">
					...
					<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
						<div class="navbar-nav ml-auto">
							<a class="nav-link" href="menuMakanan.php"><i class="fa fa-bars"></i> Menu</a>
							<a class="nav-link active utama" href="pesanan.php"><i class="fa fa-shopping-basket"></i> Pesanan <span class="sr-only">(current)</span></a>
            ...
            <table class="table table-striped table-bordered" style="width: 100%" id="datatables">
                    ...
                    <tbody>
                        <?php  
                            ...
                            $query = "SELECT * FROM pesanan WHERE idPelanggan = '{$user}'";
